...
def parse_conftype(conftype):
    beta = remove_left_of_first('_b', conftype) ; beta = remove_right_of_first('_', beta) ; beta=float(beta)/100000
    ns = remove_left_of_first('s', conftype) ; ns = int(remove_right_of_first('t', ns))
    nt = remove_left_of_first('t', conftype) ; nt = int(remove_right_of_first('_b', nt))
    nt_half=int(nt/2)
...
def parse_qcdtype(qcdtype):
    ...
    temp = remove_left_of_first('_', qcdtype) ; temp = remove_right_of_first('_', temp)
