...
def main():
    ...
    fig, ax, plots = lp.create_figure(xlims=[0.15,0.51], ylims=[1.5, 4], xlabel=r'$\tau T$', ylabel=r'$'+displaystyle+r'\frac{G^\mathrm{cont} (\tau)}{G^\mathrm{ norm }_\tau (\tau_F=0)}$', UseTex = UseTex)
