...
plots.append(ax.errorbar([1.5,2.2], [pqcd, pqcd], linewidth=0.75, alpha=0.5, zorder=-10000, color='black', fmt='--', label=r'pQCD (NLO, $\alpha\approx 0.2)$'))
plots.append(ax.errorbar(xlims, [adscft, adscft], linewidth=0.75, alpha=0.5, zorder=-10000, fmt=':', color='black', label='AdS/CFT estimate'))
...
lpd.legendstyle.update(loc="upper left", bbox_to_anchor=(0.08, 0.89), fontsize=6, framealpha=0)
