...
labelboxstyle      = dict(boxstyle="Round", fc="w", ec="w", alpha=0.8, pad=0.1, in_layout=True, zorder=99)
...
xlabelstyle        = dict(horizontalalignment='right', verticalalignment='bottom', bbox=labelboxstyle, zorder=99)
ylabelstyle        = dict(horizontalalignment='left', verticalalignment='top', rotation=0, bbox=labelboxstyle, zorder=99)
...
def create_figure(xlims=None, ylims=None, xlabel="", ylabel=""):
