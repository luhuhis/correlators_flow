    ...
    for idx in "${!models_file[@]}"; do
        for idy in "${!order[@]}" ; do
            for idf in "${!flows[@]}" ; do
                ...
                --kappa_temps 195 220 251 293 352 \
                --no_just_UV \
                --ylims -0.25 10 \
                --title " " \
                ...
                --fitparam_files \
                s096t36_b0824900_m002022_m01011/spf/${models_file[idx]}_${order[idy]}_Nf3_T0.195_${scale[idy]}_500_0.35_exp0_hisq_nt36_f${flows[idf]} \
                ...
                s096t24_b0824900_m002022_m01011/spf/${models_file[idx]}_${order[idy]}_Nf3_T0.293_${scale[idy]}_500_0.35_exp0_hisq_nt24_f${flows[idf]} \
                ...
                --PhiUV_files \
                s096t36_b0824900_m002022_m01011/spf/${models_file[idx]}_${order[idy]}_Nf3_T0.195_${scale[idy]}_500_0.35_exp0_hisq_nt36_f${flows[idf]}/phiUV.dat \
                ...
                s096t24_b0824900_m002022_m01011/spf/${models_file[idx]}_${order[idy]}_Nf3_T0.293_${scale[idy]}_500_0.35_exp0_hisq_nt24_f${flows[idf]}/phiUV.dat \
