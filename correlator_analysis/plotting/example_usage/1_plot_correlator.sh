 #!/bin/bash
conftypes_quenched=${1:-s064t16_b0687361 s080t20_b0703500 s096t24_b0719200} #s096t16_b0719200 s096t32_b0719200 s096t28_b0719200 s120t30_b0739400
...
for conftype in $conftypes_quenched ; do
    ...
    ./1_plot_correlator.py quenched $conftype &
done
