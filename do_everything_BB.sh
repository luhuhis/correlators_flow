...
# $BASEPATH_WORK_DATA/quenched_1.50Tc_zeuthenFlow/BB/<conftype>/, # where <conftype> may be, for example: # s144t36_b0754400 (meaning Ns=144, Nt=36, beta=7.544).
...
# BB_cont_quality_relflow.pdf | Contains FIG 3 in the paper. This is a multipage PDF containing plots of continuum extrapolation of BB correlator for the corresponding normalized flow times.
...
# and in
# $BASEPATH_WORK_DATA/quenched_1.50Tc_zeuthenFlow/BB
# BB_kappa_quenched_1.5Tc.txt  |  Final kappa_B value
